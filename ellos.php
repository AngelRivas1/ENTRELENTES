        ...
        <div class="hero-size divisor-flecha ellos elemento-inicio">
          <div class="hero">
            <div class="hero-content">
              <div class="">
                <h2 class="text-center"><i class="fas fa-glasses"></i><span></span> PARA ELLOS</h2>
              </div>
            </div><!-- .hero-content -->
          </div><!-- .hero -->
        </div><!-- .hero-size -->
      <section id="lentes" class="divisor-diagonal">
        <div class="container-fluid" id="ellos">
           <div class="row text-center">
              <?php
               try {
                 require_once('includes/funciones/connection_db.php');
                 $sql = "SELECT * FROM lentes_normales WHERE categoria = 'H'";
